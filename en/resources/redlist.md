...
- **IUCN Red List Categories and Criteria:**  
  <https://www.iucnredlist.org/en> :contentReference[oaicite:7]{index=7}  

- **Montserrat oriole – BirdLife Data Zone factsheet:**  
  <https://datazone.birdlife.org/species/factsheet/montserrat-oriole-icterus-oberi> :contentReference[oaicite:8]{index=8}  

- **GBIF: search occurrence data by IUCN Red List category:**  
  <https://www.gbif.org/news/3vu7HxLgHTqKtSF69oNqNr/new-feature-enables-search-of-occurrence-data-by-global-iucn-red-list-category> :contentReference[oaicite:9]{index=9}  

- **GBIF: Data use and policy relevance:**  
  <https://www.gbif.org/data-use> :contentReference[oaicite:10]{index=10}  
